...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="" target="_blank">How it works</a>
            </li>
            <li class="menu-item hidden"><a href="" >Sign in</a></li>
            <li class="menu-item hidden"><a href="" >Start a Ufundme</a>
            </li>
        </ul>
    </div>
